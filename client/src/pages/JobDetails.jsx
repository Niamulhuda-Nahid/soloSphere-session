...
const JobDetails = () => {
    ...
    const { _id, job_title, deadline, description, min_price, max_price, category, buyer } = job || {};

    const handleSubmitForm = async e => {
        e.preventDefault();
        // Buyer and Seller Email Check
        ...
        if (price < parseFloat(min_price) || price > parseFloat(max_price)) {
            return toast.error("Price shoud be equal or more then minimum price and lessthan or equale to maximum price")
        }
        ...
        try {
            ...
            toast.success("Bid this job successfully")
            form.reset();
            navigate('/my-bids');
;        } catch (err) {
                ...
                <form onSubmit={handleSubmitForm}>
                    <div className='grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2'>
                        ...
                        <div className='flex flex-col gap-2 '>
                            ...
                            <DatePicker className='border py-2 rounded-md ps-3' selected={startDate} onChange={(date) => setStartDate(date)} />
                        </div>
                    </div>
